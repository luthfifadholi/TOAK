	...
	<!-- <div id="wrapper"> -->
					...
					<div id="dropdown-account">
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<li><a href="../warga/biodata.php" style="text-align:left"><img src="../../assets/images/account-icon.png" alt="Upload" style="float:left;width:15px" /> User Mode</a></li>
		...
		<nav>
			<ul>
				...
				<li><a class="active" href="admin_biodata.php">Biodata</a></li>
		...
		<section>
			...
			<div id="berkas">
				<div class="bhead">
					<div>
						<h1 style="color: #31a9e1; width:660px; float:left;font-family:Calibri">Biodata Warga</h1>
					</div>
					<div>
						<div class="kotak-tambah hover">
							<a href="../tambah_biodata.php"><p style="clear:both;margin:6px 0px 0px 20px;">+Tambah Biodata</p></a>
						</div>
					</div>
				</div>
				<table class="jos_tabel_biodata">
					<thead>
						<tr>
							<td></td>
							<td>Detail</td>
					...
					<tbody>
						<?php 
							$query = "SELECT * FROM biodata ORDER BY id DESC";
							...
							while ($row = mysql_fetch_array($hasil)){
								...
								echo "<tr style='font-family:Calibri'>";
									...
									echo "<td valign='top'>";
										echo "<div style='font-weight:bold;color:#31a9e1'><a href='admin_detail_biodata.php?id=$id'>$nama</a></div>";
										echo "$alamat<br>";
										echo "$email<br>";
										echo "$telepon<br>";
									echo "</td>";
									echo "<td style='font-weight:bold;color:#31a9e1'>$status</td>";
									echo "<td><a href='../../proses/proses_hapus_biodata.php?id=".$row['id']."'><img src='../../assets/img/icon-hapus.png' style='width:70px;margin-right:10px;'></a>
										<a href='../edit_biodata.php?id=".$row['id']."'><img src='../../assets/img/icon-edit.png' style='width:70px;margin-right:15px'></a></td>";
								echo "</tr>";
							}
						?>	
					</tbody>
