	...
	<!-- <div id="wrapper"> -->
					...
					<div id="dropdown-account">
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<li><a href="../warga/profil.php" style="text-align:left"><img src="../../assets/images/account-icon.png" alt="Upload" style="float:left;width:15px" /> User Mode</a></li>
		...
		<nav>
			<ul>
				...
				<li><a class="active" href="admin_profil.php">Profil</a></li>
						...
						<?php 
							...
							while ($row = mysql_fetch_array($hasil)){
								...
								echo "<tr style='height:50px'>";
									echo "<td><img src='../../assets/images/$foto' style='width:200px'></td>";
									echo "<td></td>";
								echo "</tr>";
								echo "<tr style='height:50px'>";
