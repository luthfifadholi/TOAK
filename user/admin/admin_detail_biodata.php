	...
	<!-- <div id="wrapper"> -->
		...
		<section>
			...
			<div id="berkas">
				<div class="bhead">
					<div>
						<h1 style="color: #31a9e1; width:400px; float:left;font-family:Calibri">Biodata Warga</h1>
					</div>
				</div>
				<table class="jos_tabel_biodata">
					<tbody>
						<?php 
							...
							$query = "SELECT * FROM biodata WHERE id='$id' LIMIT 1";
				...
				<p><a href="admin_biodata.php">back</a></p>
			</div>
		</section>		
		<footer>
