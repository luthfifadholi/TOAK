					...
					<div id="dropdown-account">
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<li><a href="../warga/berita.php" style="text-align:left"><img src="../../assets/images/account-icon.png" alt="Upload" style="float:left;width:15px" /> User Mode</a></li>
		...
		<section>
			...
			<div id="berkas">
				<div>
					...
					<!-- <input type="search" placeholder="cari" style="float: right;" name="search"> -->
				</div>
				<br><br>
						...
						<?php 
							...
							while ($row = mysql_fetch_array($hasil)){
								...
								echo "<tr>";
									...
									echo "<td><a href='../proses/proses_hapus_biodata.php?id=".$row['id']."'><img src='../../assets/img/icon-hapus.png' style='width:70px;margin-right:10px;'></a><a href='../edit_biodata.php'><img src='../../assets/img/icon-edit.png' style='width:70px;margin-right:15px'></a></td>";
								echo "</tr>";
							}
						?>	
					</tbody>
