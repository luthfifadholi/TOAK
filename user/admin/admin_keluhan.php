	...
	<!-- <div id="wrapper"> -->
					...
					<div id="dropdown-account">
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<li><a href="../warga/keluhan.php" style="text-align:left"><img src="../../assets/images/account-icon.png" alt="Upload" style="float:left;width:15px" /> User Mode</a></li>
		...
		<nav>
			<ul>
				...
				<li><a class="active" href="admin_keluhan.php">Keluhan</a></li>
		...
		<section>
			...
			<div id="berkas">
				<div class="bhead">
					<div>
						<h1 style="color: #31a9e1; width:620px; float:left;font-family:Calibri">Keluhan Warga</h1>
					</div>
					<div>
						...
						<?php 
							...
							while ($row = mysql_fetch_array($hasil)){
								...
								echo "<tr style='font-family:Calibri'>";
									...
									echo "</td>";
									echo "<td>$tanggal</td>";
									echo "<td><a href='../../proses/proses_hapus_biodata.php?id=".$row['id']."'><img src='../../assets/img/icon-hapus.png' style='width:50px;margin-right:10px;'></a></td>";
								echo "</tr>";
							}
						?>						
					</tbody>
