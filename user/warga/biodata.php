	...
	<!-- <div id="wrapper"> -->
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<?php
									...
									echo "<li><a href='../admin/admin_biodata.php' style='text-align:left'><img src='../../assets/images/messages.png' style='float:left;width:15px' /> Admin Mode</a></li>";
								}?>
		...
		<nav>
			<ul>
				...
				<li><a class="active" href="biodata.php">Biodata</a></li>
		...
		<section>
			...
			<div id="bg1">
				<div class="bhead">
					<div>
						<h1 style="color: #31a9e1; width:550px; float:left;font-family:Calibri">Biodata Warga</h1>
					</div>
				</div>
