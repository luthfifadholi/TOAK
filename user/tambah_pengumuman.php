...
<body>
	...
	<section>
		...
		<div id="berkas">
			<h1 style="color:#31a9e1;">Tambah Pengumuman</h1>
			<hr>	
			<form method="POST" action="proses/proses_tambah_pengumuman.php">
				<table>
					<tbody>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Judul</td>
							<td valign="top"><input type="text" name="judul" placeholder="Judul" style="width:250px;height:22px"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Tempat</td>
							<td valign="top"><input type="text" name="tempat" placeholder="Tempat" style="width:250px;height:22px"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Tanggal</td>
							<td valign="top"><input type="date" name="tanggal" placeholder="Tanggal"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Waktu</td>
							<td valign="top"><input type="text" name="waktu" placeholder="Waktu" style="width:250px;height:22px;"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Status</td>
							<td valign="top">
								<select name="status">
									<option value="admin">Pilih salah satu</option>
									<option value="admin">Aktif</option>
									<option value="warga">Tidak aktif</option>
								</select>
							</td>
						</tr>
