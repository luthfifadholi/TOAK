...
<body>
	<!-- <div id="wrapper"> -->
					...
					<div id="dropdown-account">
						...
						<div class="dropdown" style="display:none;margin-top:10px;">
							<ul>
								...
								<li><a href="../prosesproses_logout.php" style="text-align:left"><img src="../assets/images/logout.png" alt="Upload" style="float:left;width:15px"/> Logout</a></li>
							</ul>
						</div>
					</div>
				</li>
		...
		<nav>
			<ul>
				...
				<li><a class="active" href="admin/admin_biodata.php">Biodata</a></li>
	...
	<section>
		...
		<div id="berkas">
			...
			<hr>	
			<form method="POST" action="../prosesproses_tambah_biodata.php" enctype="multipart/form-data">
				<table>
					<tbody>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Nama</td>
							<td valign="top"><input type="text" name="nama" placeholder="nama" style="width:250px;height:22px"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Alamat</td>
							<td valign="top"><input type="text" name="alamat" placeholder="alamat" style="width:250px;height:22px"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Email</td>
							<td valign="top"><input type="email" name="email" placeholder="email@toak.com" style="width:250px;height:22px"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Telepon</td>
							<td valign="top"><input type="number" name="telepon" placeholder="telepon" style="width:250px;height:22px;"></td>
						</tr>
						<tr>
						...
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Foto</td>
							<td valign="top"><input type="file" name="foto" required /></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Username</td>
							<td valign="top"><input type="text" name="username" placeholder="Username" style="width:250px;height:22px;"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Password</td>
							<td valign="top"><input type="password" name="password" placeholder="Password" style="width:250px;height:22px;"></td>
						</tr>
					</tbody>
				</table>
				<br>
