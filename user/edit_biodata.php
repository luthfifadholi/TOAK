<?php  
	...
	session_start();
	$id = $_GET['id'];
	$sql = mysql_query("SELECT * FROM biodata WHERE id = $id LIMIT 1");
...
<body>
	...
	<section>
		...
		<div id="berkas">
			<h1 style="color:#31a9e1;">Edit Biodata</h1>
			<hr>	
			<form method="POST" action="proses/proses_edit_biodata.php" enctype="multipart/form-data">
				<input type="hidden" value="<?php echo $id ?>" name="id_artikel"></input>
				<table>
					<tbody>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Nama</td>
							<td valign="top"><input type="text" name="nama" placeholder="Nama" style="width:250px;height:22px" value="<?php echo $row['nama'];?>"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Alamat</td>
							<td valign="top"><input type="text" name="alamat" placeholder="Alamat" style="width:250px;height:22px" value="<?php echo $row['alamat'];?>"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Email</td>
							<td valign="top"><input type="text" name="email" placeholder="Email" style="width:250px;height:22px" value="<?php echo $row['email'];?>"></td>
						</tr>
						<tr>
							<td style="font-family:Calibri;font-weight:bold;">Telepon</td>
							<td valign="top"><input type="text" name="telepon" placeholder="Telepon" style="width:250px;height:22px;" value="<?php echo $row['telepon'];?>"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td valign="top"><input type="file" name="foto" required value="<?php echo $row['foto'];?>"/></td>
						</tr>
